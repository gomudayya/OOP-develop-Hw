...
public class GameView extends BorderPane{
	...
	private void playMookJiBa() {	
		if(gameModel.playMookJiBa()==GameResult.DRAW) {
			...
			setDisableMookJiBaButtons(true);
		} 
	}
	...
	private void setDisableMookJiBaButtons(boolean flag) {
		mookButton.setDisable(flag);
		jiButton.setDisable(flag);
		BaButton.setDisable(flag);
	}
	...
	private void nextTurn() {
		...
		effect.setOnFinished(e->{
			...
			setDisableMookJiBaButtons(false);
